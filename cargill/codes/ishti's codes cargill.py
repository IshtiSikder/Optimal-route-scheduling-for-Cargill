# -*- coding: utf-8 -*-
"""
Created on Fri Feb 28 12:42:48 2020
...
I = set(range(1, Loads + 1)) # set of loads
J = set(range(1, Drivers + 1))  # set of drivers
T = list(range(1, Periods + 1)) # set of periods
L = set(range(1, Lines + 1)) # set of lines
